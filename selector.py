...
def selector(algo,func_details,popSize,Iter,completeData, optimized_cols=[]):
    ...
    #dataInput=data_set[0:numRowsData,0:-1] # Colocar o input otimizado aqui!
    #optimized_cols = [0, 4, 5, 9, 12, 13, 15, 19, 20, 24, 25, 28, 31, 32, 33, 35, 36, 40, 43, 45, 49, 51, 52, 54, 60, 62, 63, 65, 66, 67, 68, 71, 74, 76]
    #dataInput=data_set[0:numRowsData,optimized_cols] # Colocar o input otimizado aqui!
